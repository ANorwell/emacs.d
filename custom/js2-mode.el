  ...
  (save-excursion
    ...
    (let* ((ctrl-stmt-indent (js2-ctrl-statement-indentation))
      ...
      (cond
       ...
       ;; Arron remove this functionality
       ;;(chained-indent)

       (ctrl-stmt-indent)

       ;; Arron fix indent for chained functions. Why 8? No idea....
       ((and declaration-indent continued-expr-p is-chained)
        (- (+ declaration-indent js2-basic-offset)) 8)
