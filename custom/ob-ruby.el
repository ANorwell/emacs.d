...
(defvar org-babel-ruby-command "/Users/anorwell/.rbenv/shims/ruby"
...
(defvar org-babel-ruby-wrapper-method
  "
Object.send(:remove_const, :OrgBabelRubyEval) if Object.constants.include?(:OrgBabelRubyEval)
results = module OrgBabelRubyEval
  %s
end
File.open('%s', 'w'){ |f| f.write((results.class == String) ? results : results.inspect) }
")

(defvar org-babel-ruby-wrapper-method-old
  "
def main()
%s
end
...
return the value of the last statement in BODY, as elisp."
  (let* ((org-babel-ruby-command "/Users/anorwell/.rbenv/shims/ruby"))
    (if (not buffer)
